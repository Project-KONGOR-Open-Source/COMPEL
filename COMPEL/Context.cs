...
internal static class CONTEXT
{
    ...
    internal static string MasterServerAddressAndPort = MasterServerAddress + (CONTEXT.JSONConfiguration.HostingEnvironment!.Value!.ToUpper().Equals("LOCAL") ? ":5555" : string.Empty /* Port 80 Is Implied */ );
}
