...
public static partial class VersionChecker
{
    ...
    private const string LatestReleaseURL = "https://api.github.com/repos/Project-KONGOR-Open-Source/COMPEL/releases/latest";
    ...
    /// <summary>
    ///     Queries the GitHub releases API for the latest published version of COMPEL.
    /// </summary>
    ...
    /// </summary>
    internal static bool TryParseNumericVersion(string versionString, [NotNullWhen(true)] out Version? version)
    {
